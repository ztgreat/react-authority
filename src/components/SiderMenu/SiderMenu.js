...
// Allow MenuList.js config icon as string or ReactNode
//   icon: 'setting',
...
export default class SiderMenu extends PureComponent {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.location.pathname !== this.props.location.pathname) {
      ...
      // console.log('this.flatMenuKeys',this.flatMenuKeys);
      // console.log('getDefaultCollapsedSubMenus',this.getDefaultCollapsedSubMenus(nextProps));
